...
,.;:})\\]]|//))`),
    ...
    !function() {
      if ("undefined" != typeof Prism2 && "undefined" != typeof document && document.querySelector) {
        var e, t = "line-numbers", i = "linkable-line-numbers", n = /\n(?!$)/g, r = true;
        Prism2.plugins.lineHighlight = {
          highlightLines: function(o2, u2, c2) {
            var h = (u2 = "string" == typeof u2 ? u2 : o2.getAttribute("data-line") || "").replace(/\s+/g, "").split(",").filter(Boolean), d = +o2.getAttribute("data-line-offset") || 0, f = (function() {
              ...
              return e;
            }() ? parseInt : parseFloat)(getComputedStyle(o2).lineHeight), p = Prism2.util.isActive(o2, t), g = o2.querySelector("code"), m = p ? o2 : g || o2, v = [], y = g.textContent.match(n), b = y ? y.length + 1 : 1, A = g && m != g ? function(e2, t2) {
            ...
            h.forEach(function(e2) {
              ...
              if (!((n2 = Math.min(b + d, n2)) < i2)) {
                ...
                if (v.push(function() {
                  ...
                  var s2 = Prism2.plugins.lineNumbers.getLine(o2, i2), l2 = Prism2.plugins.lineNumbers.getLine(o2, n2);
                  if (s2) {
            ...
            var P = o2.id;
            if (p && Prism2.util.isActive(o2, i) && P) {
        ...
        var o = 0;
        Prism2.hooks.add("before-sanity-check", function(e2) {
        ...
        }), Prism2.hooks.add("complete", function e2(i2) {
          var n2 = i2.element.parentElement;
          if (u(n2)) {
            clearTimeout(o);
            var r2 = Prism2.plugins.lineNumbers, s2 = i2.plugins && i2.plugins.lineNumbers;
            l(n2, t) && r2 && !s2 ? Prism2.hooks.add("line-numbers", e2) : (Prism2.plugins.lineHighlight.highlightLines(n2)(), o = setTimeout(c, 1));
          }
        }), window.addEventListener("hashchange", c), window.addEventListener("resize", function() {
          s("pre").filter(u).map(function(e2) {
            return Prism2.plugins.lineHighlight.highlightLines(e2);
          }).forEach(a);
        });
      }
      function s(e2, t2) {
      ...
      function u(e2) {
        return !!(e2 && /pre/i.test(e2.nodeName) && (e2.hasAttribute("data-line") || e2.id && Prism2.util.isActive(e2, i)));
      }
      function c() {
        ...
        if (t2 && !document.getElementById(e2)) {
          ...
          n2 && (n2.hasAttribute("data-line") || n2.setAttribute("data-line", ""), Prism2.plugins.lineHighlight.highlightLines(n2, t2, "temporary ")(), r && document.querySelector(".temporary.line-highlight").scrollIntoView());
        }
      }
    }();
    !function() {
      if ("undefined" != typeof Prism2 && "undefined" != typeof document) {
        var e = "line-numbers", n = /\n(?!$)/g, t = Prism2.plugins.lineNumbers = {
          ...
          if (t2.code) {
            ...
            if (s && /pre/i.test(s.nodeName) && !i2.querySelector(".line-numbers-rows") && Prism2.util.isActive(i2, e)) {
              ...
              (l = document.createElement("span")).setAttribute("aria-hidden", "true"), l.className = "line-numbers-rows", l.innerHTML = u, s.hasAttribute("data-start") && (s.style.counterReset = "linenumber " + (parseInt(s.getAttribute("data-start"), 10) - 1)), t2.element.appendChild(l), r([
                s
              ]), Prism2.hooks.run("line-numbers", t2);
            }
          }
    ...
    !function() {
      if ("undefined" != typeof Prism2 && "undefined" != typeof document) {
        ...
        var a = Prism2.plugins.toolbar.registerButton = function(n2, a2) {
          var r2;
...
function CodeJar(editor, highlight2, opt = {}) {
  const options2 = {
    tab: "	",
    indentOn: /[({\[]$/,
    moveToNewLine: /^[)}\]]/,
  ...
  on("keydown", (event) => {
    ...
    prev = toString();
    if (options2.preserveIdent) handleNewLine(event);
    else legacyNewLineFix(event);
    if (options2.catchTab) handleTabCharacters(event);
    if (options2.addClosing) handleSelfClosingCharacters(event);
    if (options2.history) {
  ...
  function handleNewLine(event) {
    if (event.key === "Enter") {
      ...
      if (options2.indentOn.test(before)) {
      ...
      if (newLinePadding !== padding && options2.moveToNewLine.test(after)) {
        const pos = save();
        insert("\n" + padding);
        restore(pos);
      }
  ...
  function handleSelfClosingCharacters(event) {
    const open = options2.autoclose.open;
    const close = options2.autoclose.close;
  ...
  function handleTabCharacters(event) {
    if (event.key === "Tab") {
      ...
      if (event.shiftKey) {
        ...
        if (padding.length > 0) {
          const pos = save();
          const len = Math.min(options2.tab.length, padding.length);
          restore({
            start,
            end: start + len
          });
...
function withLineNumbers(highlight2, options2 = {}) {
  const opts = {
...
var highlight = (editor) => {
  const code = editor.textContent;
  const highlighted = import_prism.default.highlight(code, import_prism.default.languages.javascript, "javascript");
